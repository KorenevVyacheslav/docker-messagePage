...
(
    ...
    `brief`  varchar(40) COLLATE utf8mb4_unicode_ci NOT NULL,
    `text_`  text        COLLATE utf8mb4_unicode_ci NOT NULL,
    PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO messeges (title, author, brief, text_)
VALUES ('Lorema 1 para', 'Иванов', 'Lorem ipsum odor amet', 'Lorem ipsum odor amet, consectetuer adipiscing elit. Massa habitasse fusce phasellus placerat turpis blandit ultrices.
